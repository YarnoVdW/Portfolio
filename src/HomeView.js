...
import {Avatar, Box, Heading, HStack, Pressable, Stack, Text} from 'native-base';
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <Stack p={4} space={3}>
                    ...
                    <Text fontWeight="400">
                        Ik ben Yarno, student applicatieontwikkeling aan Karel de Grote. Al van jongs af aan ben ik heel
                        gepassioneerd over computers. Het schrikt me dus ook niet af om in mijn vrije tijd veel bij te
                        leren. Als je me niet achter mijn computer ziet zitten, zit ik waarschijnlijk in het bos op mijn
                        Mountainbike.
                    </Text>
